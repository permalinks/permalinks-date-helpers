# Contributing to permalinks-date-helpers

First and foremost, thank you! We appreciate that you want to contribute to permalinks-date-helpers, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for permalinks-date-helpers**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for permalinks-date-helpers:

- star the [project](https://github.com/jonschlinkert/permalinks-date-helpers)
- tweet your support for permalinks-date-helpers
...
- **version**: please note the version of permalinks-date-helpers are you using
...
[so]: http://stackoverflow.com/questions/tagged/permalinks-date-helpers